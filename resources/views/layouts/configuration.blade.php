...
@section('content')
    ...
    <div class="flex flex-col gap-3 w-full max-w-screen-md">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="row-span-4 grid place-items-center">
                <div
                    class="h-32 w-32 bg-gray-100 shadow-lg rounded-full flex items-center justify-center overflow-hidden">
            ...
            <div class="space-y-2">
                ...
                <input type="text" id="companyEmail" name="companyEmail"
                       value="{{ old('companyEmail', $companyEmail) }}"
                       class="mt-1 block w-full px-3 py-2 border text-xs border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
            </div>
    ...
    <script>
        ...
        function handleSaveConfig() {
            ...
            fetch(`/${PROJECT_BASE}/public/configuracion`, {
                method: 'POST',
                headers: {
        ...
        function handleChangePassword() {
            ...
            fetch(`/${PROJECT_BASE}/public/update-password`, {
                method: 'POST',
                headers: {
