...
<head>
    ...
    ><![endif]-->
    <!--[if !mso]><!-->
    <link href="https://fonts.googleapis.com/css2?family=Cabin:wght@100;200;300;400;500;600;700;800;900" rel="stylesheet"
        type="text/css" />
    <!--<![endif]-->
    <style>
        * {
        ...
        @media (max-width: 640px) {
            ...
            .row-1 .column-3 .block-1.social_block td.pad {
                padding: 0 !important;
            }
                            ...
                            "
                                  ...
                                  ">
                                    ...
                                    ">
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 8px">
                                                                        Queremos informarle que estamos trabajando
                                                                        diligentemente en la resolución de su reclamo.
                                                                        Sin embargo, el proceso tomará un tiempo
                                                                        adicional. Estimamos que necesitaremos
                                                                        aproximadamente {{ $days }} días más
                                                                        para completar la
                                                                        revisión de su caso.
                                                                    </p>
                                                                </div>
                                  ...
                                  ">
                                                                <div align="center" class="alignment">
                                                                    <a href="{{ route('complaint.show', $complaint->complaintCode) }}"
                                                                        style="color: #ffffff" target="_blank">><!--[if mso]>
                                                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                     xmlns:w="urn:schemas-microsoft-com:office:word"
                                                                     href="https://example.com"
                                                                     style="height:43px;width:171px;v-text-anchor:middle;"
                                                                     arcsize="0%" fillcolor="#393d47">
                                                            <v:stroke dashstyle="Solid" weight="1px" color="#4D4997"/>
                                                            <w:anchorlock/>
                                        ...
                                        ">
                                          ...
                                          "><span
                                              ...
                                              word-break: break-word;
                                              line-height: 32px;
                                            ">{{ $complaint->complaintCode }}</span></span>
                                                                        </div>
                              ...
                              "
                                  ...
                                  ">
                                    ...
                                    ">
                                                                    <p style="margin: 0;margin-bottom: 8px">
                                                                        Agradecemos su paciencia y comprensión mientras
                                                                        aseguramos que se le brinde la mejor solución
                                                                        posible. Si tiene alguna pregunta o requiere más
