                                    ...
                                    "
                                                >
                                                    <p style="margin: 0; margin-bottom: 16px">
                                                        ...
                                                        <strong></strong> {{$complaint->customer->name}},
                                                    </p>
                                                    <p style="margin: 0; margin-bottom: 8px">
                                                        Hay un nuevo reclamo registrado en nuestro sistema con el
                                                        código: {{" "}}
                                                    ...
                                                    <p style="margin: 0; margin-bottom: 8px">
                                                        Diríjase a la sección de reclamos para ver más detalles y
                                                        atender el reclamo.
                                                    </p>
                                                </div>
                                            </td>
