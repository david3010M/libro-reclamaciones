    ...
    public function run(): void
    {
        ...
        $questions = [
            [
                ...
                'stepper' => 1,
                'options' => [
                    'TIENDA GRAU | AV. GRAU 910 - URB VILLA EL SALVADOR',
                    'TIENDA JACARANDAS | CALLE JACARANDAS 100 - URB SANTA VICTORIA',
                    'TIENDA MALL AVENTURA | CC. MALL AVENTURA - 2DO NIVEL (Pasillo de ingreso al patio de comida)',
                    'TIENDA PATAZCA | CALLE BERNARDO ALCEDO #320 URB. PATAZCA - CHICLAYO',
                    'TIENDA REAL PLAZA CIX | CC. REAL PLAZA - 1ER NIVEL (2DO PASILLO, AL FRENTE DE LA TIENDA I SHOP',
                    'TIENDA ZARUMILLA | CALLE ZARUMILLA 084 - URB. REMIGIO SILVA',
                    'TIENDA GRAMECO LIMA | CALLE DOS 136 DPTO. B LA CALERITA, SURQUILLO - LIMA',
                    'TIENDA OPEN PLAZA PIURA | CC. OPEN PLAZA - 1ER NIVEL (Frente a BCP)',
                    'TIENDA REAL PLAZA PIURA | CC. REAL PLAZA – 1ER NIVEL (FRENTE AL OECHSLE)',
                ],
